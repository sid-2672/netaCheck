...
class TestExceptionMessages:
    def test_politician_not_found_message_contains_slug(self):
        exc = PoliticianNotFoundError(slug="narendra-modi")
        assert "narendra-modi" in exc.detail
        assert exc.context["slug"] == "narendra-modi"

    def test_source_missing_message_contains_field(self):
    ...
    def test_data_conflict_carries_both_sources(self):
    ...
    def test_robots_disallowed_message_contains_url(self):
        url = "https://myneta.info/private/page"
        exc = RobotsDisallowedError(url=url)
        assert url in exc.detail

    def test_parse_error_carries_source_and_reason(self):
    ...
    def test_pdf_error_carries_slug_and_reason(self):
    ...
    def test_invalid_api_key_detail_message(self):
        exc = InvalidApiKeyError()
...
class TestExceptionRepr:
    ...
    def test_netacheck_error_str_is_detail(self):
